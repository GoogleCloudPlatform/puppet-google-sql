...
Puppet::Type.type(:gsql_ssl_cert).provide(:google) do
  mk_resource_methods
  ...
  def self.prefetch(resources)
    Puppet.warning [
      "gsql_ssl_cert will be deprecated in a future release.",
      "You can use strings to reference GCP SslCert.",
      "A gsql_ssl_cert is no longer necessary"
    ].join(" ")
    debug('prefetch')
  ...
  def resource_to_request
    request = {
      kind: 'sql#sslCert',
      cert: @resource[:cert],
      certSerialNumber: @resource[:cert_serial_number],
